...
## Deploy
Sito statico, nessun build step. Deploy diretto su Vercel:
1. push del repo su GitHub
2. import del repo su Vercel → framework preset: **Other** (nessun build)
3. output directory: root (`/`)

## Note
- Nessuna dipendenza, nessun JS di terze parti esterno.
- Font e immagini sono self-hosted (nessun hotlink esterno).
